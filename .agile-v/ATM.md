...
<!-- REQ ↔ ART ↔ TC ↔ Verification result -->
...
| REQ-0007 | ART-0018–0019 | TC-0009 | **PASS** (static) | Red Team |
| REQ-0008 | ART-0006–0007 | TC-0010 | **PASS** (static) | Red Team |
| REQ-0009 | ART-0002, ART-0020 | TC-0011 | NOT RUN; **FLAG** prod | Red Team |
| REQ-0010 | ART-0021 | TC-0012 | NOT RUN | Red Team |
...
| REQ-0020 | ART-0033–0034 | TC-0022 | **PASS** (static) | Red Team |
| REQ-0022 | ART-0025 | TC-0023 | FLAG (partial) | Red Team |
| REQ-0023 | ART-0025 | TC-0024 | **PASS** (static) | Red Team |
| REQ-0024 | ART-0028 | — | **PASS** (bootstrap) | Compliance Auditor |
...
- **Implemented REQs with ART link:** 18 / 18 (0001–0012, 0019–0020, 0022–0027)
- **Planned REQs (0013–0018, 0021):** ART placeholders in BUILD_MANIFEST
