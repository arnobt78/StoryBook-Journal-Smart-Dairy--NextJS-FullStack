...
| CR-0006 | C4 | REQ-0010 | Groq model migration — multi-model shuffle fallback chain | Groq deprecates llama-3.3-70b-versatile Aug 16 2026; free-tier resilient failover | ART-0108; TC-0046 | Project Owner | **APPROVED** (Wave 49) |
| CR-0007 | C4 | REQ-0010, REQ-0029 | AI reasoning leak fix + write-footer button parity | Groq reasoning models default raw chain-of-thought in content; Save button 2px shorter than siblings | ART-0108; TC-0046 | Project Owner | **APPROVED** (Wave 50) |
| CR-0008 | C4 | REQ-0029, REQ-0003 | Book-clip parity + flip seam + AI writing status + edit no-flash | Journal book right corner clipped at rest (tilt projects 16px past pinned width) vs auth (no tilt); flip-time reveal caused width pop + spiral shadow flash; edit-click flash; plain "Writing…" text | ART-0109; visual + runtime-log verified | Project Owner | **APPROVED** (Wave 51) |
